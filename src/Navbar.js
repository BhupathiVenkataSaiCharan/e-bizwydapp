      ...
      >
        ...
        <div className="list">
                    ...
                    <ul>
                        ...
                        <li><NavLink to="/location"><LocationOnIcon/></NavLink></li>
                        <li><NavLink to="/partners">Partners</NavLink></li>
                        <li><NavLink to="/collab">Collab</NavLink></li>
                        <li><NavLink to="/search"><SearchIcon/></NavLink></li>
                        <li><NavLink to="/cart"><ShoppingCartIcon/></NavLink></li>
                        <li className="button"><NavLink to="/login"><AccountCircleRoundedIcon/></NavLink></li>
                    </ul>
                    </nav>
                </div>
      </AppBar>  
